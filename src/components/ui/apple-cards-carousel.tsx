    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-accent/20 hover:bg-accent transition-colors disabled:opacity-50"
            onClick={scrollLeft}
          ...
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="mt-4 heading-lg text-foreground md:heading-xl"
              >
                {card.title}
              </motion.p>
      ...
      >
        ...
        <div className="relative z-40 p-8">
          <motion.p
            ...
            className="text-left font-sans text-sm font-medium text-white md:text-base uppercase tracking-wider"
          >
            {card.category}
          </motion.p>
          <motion.p
